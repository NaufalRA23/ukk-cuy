<!-- filepath: /c:/laragon/www/tokolaptop/resources/views/layouts/mainPimpinan.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark show" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <a class="nav-link {{ request()->routeIs('index.pimpinan') ? 'active' : '' }}" href="{{ route('index.pimpinan') }}">

...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{ url('/member') }}">Toko Laptop</a>
        <!-- Navbar Search-->
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            {{-- <li class="nav-item position-relative">
                <a class="nav-link" href="{{ url('/keranjang') }}" style="position: relative;">
                    <i class="fas fa-shopping-cart text-white fa-lg"></i>
                    <span class="position-absolute top-0 start-100 translate-middle badge"
                          style="background-color: white; color: #212529; font-size: 0.7rem;
                                 padding: 4px 8px; border-radius: 30px;
                                 transform: translate(-30%, -40%); border: 1px solid #212529;">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link {{ request()->is('indexMember') ? 'active' : '' }}" href="{{ url('/indexMember') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Dashboard
                        </a>
                        <a class="nav-link {{ request()->is('transMember') ? 'active' : '' }}" href="{{ url('/transMember') }}">
